...
curl -fsSL https://github.com/Ga0512/SursumAI/raw/v1.0.4/install.sh | bash
...
sursumai uninstall  # remove SursumAI from this computer
```
...
A Pro subscription is not cancelled by it.
