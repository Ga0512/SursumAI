...
# One build for everyone: there is a single repository to update from. What Pro
# adds is downloaded separately, by the account that paid for it.
REPO = "Ga0512/SursumAI"
...
async def meta_update_apply():
    ...
    tag = f"v{latest}"
    # the installer comes from the tag being installed, never from a branch
    fetch = f"curl -fsSL {REPO_BASE}/raw/{tag}/install.sh"
